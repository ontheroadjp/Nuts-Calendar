...
describe('store/module/userCalendar/update.js', () => {
    ...
    const { PREPARE, IS_LOADING, SET_VALUE, SET_UPDATE_VALUE, RESET, NOTIFY_SUCCESS, NOTIFY_DANGER } = updateModule.mutations;
    ...
    describe('actions', () => {
        ...
        it('update', (done) => {
            ...
            testAction(update, false, { state }, [
                ...
                { type: 'userCalendar/SET_VALUE', payload: { id: 100, key: 'name', value: 'updated name' } },
                { type: 'userCalendar/SET_VALUE', payload: { id: 100, key: 'description', value: 'updated description' } },
