import removeModule from '../../../../../../src/store/modules/userCalendar/remove.js';
import { testAction } from '../../../helper.js';
import { expect } from 'chai';
import sinon from 'sinon';
import Promise from 'bluebird';

describe('store/module/userCalendar/remove.js', () => {
    const { state } = removeModule;
    const { remove } = removeModule.actions;
    const { IS_LOADING, NOTIFY_SUCCESS, NOTIFY_DANGER, REMOVE } = removeModule.mutations;
