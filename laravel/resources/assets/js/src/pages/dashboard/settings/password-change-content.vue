        ...
        methods: {
            putChangePassword: function() {
                ...
                this.execPutPasswordChange()
                    .then(response => {
                        u.clog('success')
                        this.resultPasswordChange(true, 'saved!', 'green');
                    })
                    .catch(error => {
                        u.clog('error');
                        this.resultPasswordChange(false, 'error', 'red');
                    });
            },

            resultPasswordChange: function (status, message, color) {
                ...
                this.$emit('update:result', status);
            }
        }
    }
</script>
